...
<span class="line"><span style="color:#E1E4E8;">  }</span></span>
<span class="line"><span style="color:#E1E4E8;">})</span></span></code></pre></div><p>也可参考：<a href="/guide/typescript/composition-api.html#typing-template-refs">为模板引用标注类型</a> <sup class="vt-badge ts"></sup></p></div><h2 id="refs-inside-v-for" tabindex="-1"><code>v-for</code> 中的模板引用 <a class="header-anchor" href="#refs-inside-v-for" aria-label="Permalink to &quot;\`v-for\` 中的模板引用 {#refs-inside-v-for}&quot;">​</a></h2><blockquote><p>需要 v3.5 及以上版本</p></blockquote><div class="composition-api"><p>当在 <code>v-for</code> 中使用模板引用时，对应的 ref 中包含的值是一个数组，它将在元素被挂载后包含对应整个列表的所有元素：</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code" tabindex="0"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">script</span><span style="color:#B392F0;"> setup</span><span style="color:#E1E4E8;">&gt;</span></span>
