...
2. 通过在 HTML 外壳中添加 `<script type="module" src="/client.js"></script>` 来加载客户端入口。
3. 通过在 HTML 外壳中添加一个 [Import Map](https://github.com/WICG/import-maps) 来支持浏览器中的 `import * from 'vue'` 这类用法。
