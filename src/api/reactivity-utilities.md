...
检查一个对象是否是由 [`shallowRef`](./reactivity-advanced#shallowref)、[`shallowReactive()`](./reactivity-advanced#shallowreactive) 或 [`shallowReadonly()`](./reactivity-advanced#shallowreadonly) 创建的代理对象。
